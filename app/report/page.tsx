      ...
      <div className="container mx-auto px-4">
        <article className="prose prose-invert prose-headings:text-teal-300 prose-h2:text-teal-400 prose-strong:text-teal-400 max-w-4xl mx-auto bg-gray-800/80 backdrop-blur-sm p-6 sm:p-8 rounded-lg shadow-xl border border-teal-500/30">
          ...
          <p>
            ...
            Initiatives like the O'MEALS school feeding program (boosting enrollment by ~25% initially) and the "Opon
            Imo" digital learning tablets have been impactful.
          </p>
          <p>
          ...
          <p>
            Osun excels in child health, with under-5 stunting at 7.2% (national: 37%) and underweight at 6% (national:
            22%). Immunization coverage is good, with only ~8% of children receiving no vaccinations (national: ~18%).
            The Osun Health Insurance Scheme (OHIS), launched in 2018, has improved healthcare access and affordability
            for thousands.
          </p>
          <p>
          ...
          <p>
            ...
            Program" (launched 2023) targets training 50,000 youths in digital and entrepreneurial skills. Support for
            SMEs and agripreneurship is also emphasized, though access to finance remains a hurdle.
          </p>
          ...
          <p>
            Youth (under 30) constitute ~55-60% of Osun's population. The 'Not Too Young To Run Act' has increased youth
            participation in politics. The National Youth Council of Nigeria (NYCN) Osun chapter is active, and events
            like the Osun Emerging Leaders Summit (2023) foster youth leadership.
          </p>
          <p>
          ...
          <p>
            Osun State's trajectory in child and youth development showcases significant strengths and a commitment to
            progressive policymaking. The state compares favorably to national benchmarks in many areas, particularly
            health and literacy.
          </p>
          <p>
