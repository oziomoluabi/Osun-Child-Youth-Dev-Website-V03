      ...
      <div className="container mx-auto px-4">
        <header className="text-center mb-12">
          ...
          <p className="text-lg text-gray-300 mt-4 max-w-3xl mx-auto">
            Highlighting the vibrant role of Osun's youth in governance, community development, and policy influence,
            supported by state initiatives and active youth organizations.
          </p>
        </header>
        ...
        <div className="space-y-12">
          ...
          <section className="bg-gray-800/80 backdrop-blur-sm p-6 sm:p-8 rounded-lg shadow-xl border border-teal-500/30">
            ...
            <div className="text-gray-300 space-y-4">
              <p>
                Youth in Osun are increasingly influential in politics. The 'Not Too Young To Run Act' (2018) has
                enabled more young people to seek elective office. Voter turnout among youth is high, and the state
          ...
          <section className="bg-gray-800/80 backdrop-blur-sm p-6 sm:p-8 rounded-lg shadow-xl border border-teal-500/30">
            ...
            <p className="text-gray-300">
              Osun's youth are active in community development committees, volunteer groups, and traditional festivals.
              International partners like the U.S. Consulate (e.g., "Osun Girls Can Code", YALI Network), Open Society
              University Network, and the British Council have supported various youth engagement and skills programs,
