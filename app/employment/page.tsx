      ...
      <div className="container mx-auto px-4">
        <header className="text-center mb-12">
          ...
          <p className="text-lg text-gray-300 mt-4 max-w-3xl mx-auto">
            Exploring Osun's unique position with the lowest unemployment rate in Nigeria, driven by innovative youth
            empowerment schemes and a growing focus on skills development.
          </p>
        </header>
