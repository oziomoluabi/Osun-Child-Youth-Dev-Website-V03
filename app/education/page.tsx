        ...
        <div className="space-y-12">
          ...
          <section className="bg-gray-800/80 backdrop-blur-sm p-6 sm:p-8 rounded-lg shadow-xl border border-teal-500/30">
            ...
            <p className="text-gray-300 mb-8">
              Osun's adult literacy rate of approximately 84.5% stands as a testament to its long-term investment in
              education, far exceeding the national average of 62%. This positions the state favorably, though it still
              trails behind leaders like Lagos. However, challenges in educational quality persist, particularly in
              rural areas where infrastructure can be lacking.
            </p>
          ...
          <section className="bg-gray-800/80 backdrop-blur-sm p-6 sm:p-8 rounded-lg shadow-xl border border-teal-500/30">
            ...
            <div className="text-gray-300 space-y-4">
              ...
              <p>
                <strong className="text-teal-400">Opon Imo:</strong> The "Tablet of Knowledge" was an early initiative
                to enhance learning with technology by providing digital tablets to secondary students.
              </p>
              <p>
                <strong className="text-teal-400">Infrastructure & Recruitment:</strong> Recent efforts have focused on
                rehabilitating schools, building "mega-schools," and hiring more teachers to improve student-teacher
                ratios and overall educational quality, contributing to improved exam results.
              </p>
            </div>
          </section>
        </div>
