        ...
        <div className="space-y-12">
          <section className="bg-gray-800/80 backdrop-blur-sm p-6 sm:p-8 rounded-lg shadow-xl border border-teal-500/30">
            ...
            <p className="text-gray-300 mb-8">
              Child labor in Osun, estimated at 10-15%, is significantly lower than Nigeria's national average of 31.5%.
              Common forms include street hawking and agricultural work. Enforcement agencies conduct raids and
